    ...
    <li class="breadcrumb-item active" aria-current="page">Desactivar</li>
                            ...
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Desactivar usuarios reciente añadidos el dia de hoy</p>
                                </div>
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
   ...
   <div class="form-group">
    ...
    <input disabled type="text" value="<?php echo  $f->nombre  ; ?>" class="form-control"   name="txtnaame"  placeholder="Nombre de la categoria">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="text" value="<?php echo  $f->usuario  ; ?>" class="form-control"   name="txtuse" disabled placeholder="Nombre de la categoria">
</div>   
  </div>
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="email" value="<?php echo  $f->correo  ; ?>" class="form-control"   name="txtmail" disabled placeholder="Nombre de la categoria">
</div>   
  </div>
