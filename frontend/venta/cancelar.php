...
<div class="body-overlay"></div>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="../venta/mostrar.php">Ventas </a></li>
    <li class="breadcrumb-item active" aria-current="page">Desactivar</li>
        ...
        <div class="card" style="min-height: 485px">
            <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Desactivar venta</p>
                                </div>
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   ...
   <div class="form-group">
    ...
    <input type="text" readonly value="<?php echo  $f->nomcli  ; ?> <?php echo  $f->apecli  ; ?>"  class="form-control"  name="txtnampr" required placeholder="Nombre del producto">
   <input type="hidden" value="<?php echo  $f->idord  ; ?>" name="txtidc">
</div>   
  </div> 
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    <label for="email">Fecha<span class="text-danger">*</span></label>
    <input type="text" readonly value="<?php echo  $f->placed_on  ; ?>"  class="form-control"  name="txtnampr" required placeholder="Nombre del producto">
   ...
   <div class="form-group">
    ...
    <input type="text" readonly value="<?php echo  $f->tipc  ; ?> "  class="form-control"  name="txtnampr" required placeholder="Nombre del producto">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="text" readonly value="<?php echo  $f->method  ; ?> "  class="form-control"  name="txtnampr" required placeholder="Nombre del producto">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="text" readonly value="<?php echo  $f->payment_status  ; ?> "  class="form-control"  name="txtnampr" required placeholder="Nombre del producto">
...
<div class="form-group">
        <div class="col-sm-12">
          <button name='stdltvent' class="btn btn-success text-white">Guardar</button>
  ...
  <script src="../../backend/js/sweetalert.js"></script>
   ...
   <?php
    include_once '../../backend/php/st_dltvent.php'
?>
