               ...
               <div class="main-content">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                ...
                                <br>
                                <a href="../venta/nuevo.php" class="btn btn-danger text-white"
                            >Nueva venta</a>
                            <br>
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?> 
    ...
    <a class="btn btn-primary text-white" href="../venta/informacion.php?id=<?php echo  $g->idord; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>visibility</i></a>

   

    <a class="btn btn-danger text-white" href="../venta/cancelar.php?id=<?php echo  $g->idord; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>cancel</i></a>

    <a class="btn btn-success text-white" href="../venta/ticket.php?id=<?php echo  $g->idord; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>print</i></a>
