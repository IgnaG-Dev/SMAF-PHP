...
<br>
   ...
   <div class="form-group">
    ...
    <input readonly type="text" maxlength="14" value="<?php echo  $f->codba  ; ?>"  class="form-control"  name="txtcode"  placeholder="Código del producto">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="text"  class="form-control" value="<?php echo  $f->nomprd  ; ?>" name="txtnampr" readonly placeholder="Nombre del producto">
  ...
  <div class="col-md-4 col-lg-4">
   ...
   <div class="form-group">
    ...
    <input type="text"  value="<?php echo  $f->precio  ; ?>" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtpre" readonly placeholder="Precio del producto">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="text" value="<?php echo  $f->stock  ; ?>" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtstc" readonly placeholder="Precio del producto">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="date" value="<?php echo  $f->venci  ; ?>"  class="form-control"  name="txtvenc" readonly placeholder="Precio del producto">
