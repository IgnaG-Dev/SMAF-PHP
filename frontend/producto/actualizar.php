    ...
    <li class="breadcrumb-item active" aria-current="page">Actualizar</li>
                            ...
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Actualizar producto reciente añadidos el dia de hoy</p>
                                </div>
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
   ...
   <div class="form-group">
    ...
    <input type="text" maxlength="14" value="<?php echo  $f->codba  ; ?>"  class="form-control"  name="txtcode" required placeholder="Código del producto">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="text"  class="form-control" value="<?php echo  $f->nomprd  ; ?>" name="txtnampr" required placeholder="Nombre del producto">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <select class="form-control" required name="txtcate">
        <option value="<?php echo  $f->idcate  ; ?>"><?php echo  $f->nomca  ; ?></option>
   ...
   <div class="form-group">
    ...
    <input type="text"  value="<?php echo  $f->precio  ; ?>" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtpre" required placeholder="Precio del producto">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="text" maxlength="4" value="<?php echo  $f->stock  ; ?>" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="txtstc" required placeholder="Precio del producto">
  ...
  <div class="col-md-4 col-lg-4">
   <div class="form-group">
    ...
    <input type="date" value="<?php echo  $f->venci  ; ?>"  class="form-control"  name="txtvenc" required placeholder="Precio del producto">
   ...
   <div class="form-group">
    ...
    <select class="form-control" required name="txtesta">
          <option value="<?php echo  $f->esta  ; ?>"><?php echo  $f->esta  ; ?></option>    
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdprod' class="btn btn-success text-white">Guardar</button>                       
