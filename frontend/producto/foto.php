...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
   ...
   <div class="form-group">
    ...
    <input type="text" readonly maxlength="14" value="<?php echo  $f->codba  ; ?>"  class="form-control"  name="txtcode"  placeholder="Código del producto">
  ...
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    ...
    <div class="form-group">
    <label for="email">Foto del producto<span class="text-danger">*</span></label>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdprodf' class="btn btn-success text-white">Guardar</button>                       
