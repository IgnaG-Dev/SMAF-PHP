...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
   ...
   <div class="form-group">
    <label for="email">Detalle de los gastos<span class="text-danger">*</span></label>
   
    <textarea class="form-control" name="detta" rows="5" cols="33" required></textarea>
   ...
   <div class="form-group">
    ...
    <input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required class="form-control" name="montoot">
</div>   
  </div>
