                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Nuevas compras reciente añadidos el dia de hoy</p>
                                </div>
                                <br>
                                <a href="../compra/nuevo.php" class="btn btn-danger text-white"
                            >Nueva compra</a>
                            <br>
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?> 
    ...
    <a class="btn btn-primary text-white" href="../compra/informacion.php?id=<?php echo  $g->idcomp; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>visibility</i></a>

   

    <a class="btn btn-danger text-white" href="../compra/cancelar.php?id=<?php echo  $g->idcomp; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>cancel</i></a>

    <a class="btn btn-success text-white" href="../compra/ticket.php?id=<?php echo  $g->idcomp; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>print</i></a>
