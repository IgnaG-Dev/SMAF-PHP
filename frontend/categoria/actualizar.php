    ...
    <li class="breadcrumb-item active" aria-current="page">Actualizar</li>
                            ...
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Actualizar categorias reciente añadidos el dia de hoy</p>
                                </div>
...
<?php
 ...
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM categoria  WHERE categoria.idcate= '$id';");
 $sentencia->execute();
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
   ...
   <div class="form-group">
    <label for="email">Nombre de la categoria<span class="text-danger">*</span></label>
    <input type="text" value="<?php echo  $f->nomca  ; ?>" class="form-control"   name="txtnaame" required placeholder="Nombre de la categoria">
    <input type="hidden" value="<?php echo  $f->idcate  ; ?>" name="txtidc">
  ...
  <div class="col-md-6 col-lg-6">
   <div class="form-group">
    <label for="email">Estado de la categoria<span class="text-danger">*</span></label>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdcate' class="btn btn-success text-white">Guardar</button>                       
            <a class="btn btn-danger text-white" href="../categoria/mostrar.php">Cancelar</a>
        </div>
    </div>
</form>
<?php endforeach; ?>
  ...
  <script src="../../backend/js/sweetalert.js"></script>
   <?php
    include_once '../../backend/php/st_updcate.php'
?>
