               ...
               <div class="main-content">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                ...
                                <br>
                                <a href="../categoria/nuevo.php" class="btn btn-danger text-white"
                            >Nueva categoria</a>
                            <br>
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?> 
    ...
    <a class="btn btn-warning text-white" href="../categoria/actualizar.php?id=<?php echo  $g->idcate; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>edit</i></a>
    <a class="btn btn-danger text-white" href="../categoria/eliminar.php?id=<?php echo  $g->idcate; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>cancel</i></a>
                <?php  }   else {?> 
<a class="btn btn-warning text-white" href="../categoria/actualizar.php?id=<?php echo  $g->idcate; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>edit</i></a>
            <?php  } ?>
                                                </td>
