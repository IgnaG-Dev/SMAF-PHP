                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" value="<?php echo  $f->ini; ?>" class="form-control" name="txtini" required placeholder="Nombre del producto">
                                                    ...
                                                    <div class="col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="fechad" value="<?php echo  $f->fin; ?>" class="form-control" name="txtfin" required placeholder="Nombre del producto">
