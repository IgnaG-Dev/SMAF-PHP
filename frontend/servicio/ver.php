                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo  $f->prec; ?>" disabled name="txtcanc" placeholder="">
                                                    ...
                                                    <div class="col-md-4 col-lg-4">
                                                        <div class="form-group">
                                                            <label for="email">Abono<span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo  $f->canc; ?>" disabled name="txtcanc" placeholder="">
                                                    ...
                                                    <div class="col-md-4 col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            ?>
                                                            <input type="text" value="<?php echo $result; ?>" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" disabled name="txtcanc" placeholder="">
